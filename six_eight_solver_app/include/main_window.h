...
{
   using dak::six_eight::puzzle_t;
   using dak::six_eight::solution_t;
   using dak::six_eight::tile_t;
   using dak::six_eight::all_solutions_t;

   /////////////////////////////////////////////////////////////////////////
   //
   // Main window of the six_eight solver app.
