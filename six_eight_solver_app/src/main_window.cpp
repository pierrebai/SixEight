...
namespace dak::six_eight_solver_app
{
   ...
   static void draw_tile_in_scene(const tile_t& a_tile, const six_eight::position_t& a_pos, QGraphicsScene& a_scene, size_t a_color)
   {
   ...
   void main_window_t::draw_selected_solution()
   {
      ...
      {
         draw_tile_in_scene(selected_tile.value(), selected_pos.value(), *scene, 8);
      }
